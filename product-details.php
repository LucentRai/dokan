				...
				<div class="col-2">
					...
					<div class="small-img-row">
						<div class="small-img-col">
							<img src="assets/img/gallery-1.jpg" class="small-img" />
						</div>
						<div class="small-img-col">
							<img src="assets/img/gallery-2.jpg" class="small-img" />
						</div>
						<div class="small-img-col">
							<img src="assets/img/gallery-3.jpg" class="small-img" />
						</div>
						<div class="small-img-col">
							<img src="assets/img/gallery-4.jpg" class="small-img" />
						</div>
					</div>
				</div>
				<div class="col-2">
					...
					<h4><span class="currency">रु</span>50.00</h4>
					<select name="" id="">
